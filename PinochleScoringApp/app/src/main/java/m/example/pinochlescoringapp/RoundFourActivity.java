...
public class RoundFourActivity extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        bid_editText.setText(Integer.toString(MainActivity.r4_bid));
        ...
        if (MainActivity.r4_suit == "spades")
        {
        ...
        else if (MainActivity.r4_suit == "hearts")
        {
        ...
        else if (MainActivity.r4_suit == "clubs")
        {
            spade_image.setBackgroundColor(getResources().getColor(R.color.unselected_image));
            heart_image.setBackgroundColor(getResources().getColor(R.color.unselected_image));
        ...
        else if (MainActivity.r4_suit == "diamonds")
        {
            spade_image.setBackgroundColor(getResources().getColor(R.color.unselected_image));
            heart_image.setBackgroundColor(getResources().getColor(R.color.unselected_image));
            club_image.setBackgroundColor(getResources().getColor(R.color.unselected_image));
        ...
        team_1_meld_editText.setText(Integer.toString(MainActivity.r4_team_1_meld));
        EditText team_2_meld_editText = findViewById(R.id.team_2_meld_editText);
        team_2_meld_editText.setText(Integer.toString(MainActivity.r4_team_2_meld));
        ...
        team_1_tricks_editText.setText(Integer.toString(MainActivity.r4_team_1_tricks));
        EditText team_2_tricks_editText = findViewById(R.id.team_2_tricks_editText);
        team_2_tricks_editText.setText(Integer.toString(MainActivity.r4_team_2_tricks));

        TextView team_1_round_score_textView = findViewById(R.id.team_1_round_score_textView);
        String cat1;
        cat1 = MainActivity.team_1_name + ": " + MainActivity.r4_team_1_score;
        ...
        String cat2;
        cat2 = MainActivity.team_2_name + ": " + MainActivity.r4_team_2_score;
    ...
    public void team_2_button_handler(View view) {
        ...
        //Select that team 2 got the bid in round 4
        MainActivity.r4_team = 2;
    }
    ...
    public void team_1_button_handler(View view) {
        ...
        //Select that team 1 got the bid in round 4
        MainActivity.r4_team = 1;
    }
    ...
    public void spade_image_handler(View view) {
        ...
        //Select that spades is trump in round 4
        MainActivity.r4_suit = "spades";
    }
    ...
    public void heart_image_handler(View view) {
        ...
        //Select that hearts is trump in round 4
        MainActivity.r4_suit = "hearts";
    }
    ...
    public void club_image_handler(View view) {
        ...
        //Select that clubs is trump in round 4
        MainActivity.r4_suit = "clubs";
    }
    ...
    public void diamond_image_handler(View view) {
        ...
        //Select that diamonds is trump in round 4
        MainActivity.r4_suit = "diamonds";
    }
    ...
    public void team_1_took_all_button_handler(View view) {
        ...
        MainActivity.r4_team_2_meld_multiplier = 0;
    }
    ...
    public void team_2_took_all_button_handler(View view) {
        ...
        MainActivity.r4_team_1_meld_multiplier = 0;
    }
    ...
    public void done_button_handler(View view) {
        ...
        MainActivity.r4_bid = Integer.parseInt(bid_editText.getText().toString());
        MainActivity.r4_team_1_meld = Integer.parseInt(team_1_meld_editText.getText().toString());
        MainActivity.r4_team_2_meld = Integer.parseInt(team_2_meld_editText.getText().toString());
        MainActivity.r4_team_1_tricks = Integer.parseInt(team_1_tricks_editText.getText().toString());
        MainActivity.r4_team_2_tricks = Integer.parseInt(team_2_tricks_editText.getText().toString());

        //Check tricks taken to update the meld multiplier in case user clicked wrong button and changed later
        if (MainActivity.r4_team_1_tricks > 0)
        {
            MainActivity.r4_team_1_meld_multiplier = 1;
        }
        if (MainActivity.r4_team_2_tricks > 0)
        {
            MainActivity.r4_team_2_meld_multiplier = 1;
        }

        //Calculate round scores
        if (MainActivity.r4_team == 1)
        {
            MainActivity.r4_team_2_score =
                    (MainActivity.r4_team_2_meld * MainActivity.r4_team_2_meld_multiplier)
                            + MainActivity.r4_team_2_tricks;

            MainActivity.r4_team_1_score =
                    (MainActivity.r4_team_1_meld * MainActivity.r4_team_1_meld_multiplier)
                            + MainActivity.r4_team_1_tricks;
            if (MainActivity.r4_team_1_score < MainActivity.r4_bid)
            {
                MainActivity.r4_team_1_score = -MainActivity.r4_bid;
            }
        }
        else if (MainActivity.r4_team == 2)
        {
            MainActivity.r4_team_1_score =
                    (MainActivity.r4_team_1_meld * MainActivity.r4_team_1_meld_multiplier)
                            + MainActivity.r4_team_1_tricks;
            ...
            MainActivity.r4_team_2_score =
                    (MainActivity.r4_team_2_meld * MainActivity.r4_team_2_meld_multiplier)
                            + MainActivity.r4_team_2_tricks;
            if (MainActivity.r4_team_2_score < MainActivity.r4_bid)
            {
                MainActivity.r4_team_2_score = -MainActivity.r4_bid;
            }
        }
